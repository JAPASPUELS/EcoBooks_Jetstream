<div class="sidebar close">
    ...
    <ul class="nav-links">
        ...
        <a class="delimiter pl-10 border-t-2 border-t-green-500  bg-green-500 mt-1">
            {{-- <i class='fas fa-shopping-cart icon ml-5' style="color: #03A9F4;"></i> --}}
            <span class="link_name ">Gestión Comercial</span>
        </a>
        ...
        <a class="delimiter pl-10 border-t-2 border-t-green-500  bg-green-500 mt-1">
            {{-- <i class='fas fa-shopping-cart icon ml-5' style="color: #03A9F4;"></i> --}}
            <span class="link_name">Gestión Financiera</span>
        </a>
        ...
        <a class="delimiter pl-10 border-t-2 border-t-green-500  bg-green-500 mt-1">
            {{-- <i class='fas fa-shopping-cart icon ml-5' style="color: #03A9F4;"></i> --}}
            <span class="link_name">Gestión de Inventario</span>
        </a>
        ...
        <a class="delimiter pl-10 border-t-2 border-t-green-500  bg-green-500 mt-1">
            {{-- <i class='fas fa-shopping-cart icon ml-5' style="color: #03A9F4;"></i> --}}
            <span class="link_name">Gestión de Relaciones</span>
        </a>
        ...
        <a class="delimiter pl-10 border-t-2 border-t-green-500  bg-green-500 mt-1">
            {{-- <i class='fas fa-shopping-cart icon ml-5' style="color: #03A9F4;"></i> --}}
            <span class="link_name">Gestión de Usuarios Roles</span>
        </a>
