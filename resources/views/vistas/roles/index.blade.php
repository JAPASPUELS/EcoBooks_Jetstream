                ...
                <tbody id="categoryTable">
                    ...
                    <tr>
                        ...
                        <td data-label="Acciones">
                            <button class="btn btn-edit" data-id="{{ $rol->rol_id }}" data-name="{{ $rol->rol_nombre }}" data-description="{{ $rol->rol_descripcion }}" data-active="{{ $rol->active }}">
                                <i class='bx bx-edit'></i>
                            </button>
                            <button class="btn btn-delete" data-id="{{ $rol->rol_id }}" data-uso="{{ $rol->active }}">
                    ...
                    <div class="mt-3 text-center sm:items-start sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <form id="registroForm" method="POST" action="">
                                @csrf
                                <div class="mb-4">
                                    <label for="rol_nombre" class="block text-sm font-medium text-gray-700">Nombre</label>
                                    <input type="text" name="rol_nombre" id="cat_name_modal" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                                <div class="mb-4">
                                    <label for="rol_descripcion" class="block text-sm font-medium text-gray-700">Descripción</label>
                                    <textarea name="rol_descripcion" id="cat_description_modal" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-3 text-center sm:items-start sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2 ">
                            <button class="w-full inline-flex justify-center mr-16 rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:mt-0 sm:w-auto sm:text-sm" id="excelBtn">
                                Excel
                            </button>
