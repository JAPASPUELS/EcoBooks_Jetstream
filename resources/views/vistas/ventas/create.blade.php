            ...
            <div class="p-6">
                <form>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-group relative">
                            ...
                            <input type="text"
                                ...
                                id="cedula" placeholder="9999999999">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                id="cliente" placeholder="" disabled>
                        </div>
                        <div class="form-group">
                            <label for="pago" class="block text-sm font-medium text-gray-700">Pago</label>
                            <input type="text"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                id="pago" placeholder="Efectivo">
                        </div>
                        <div class="form-group">
                            <label for="fecha" class="block text-sm font-medium text-gray-700">Fecha</label>
                            <input type="date"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                id="fecha" value="2024-07-04">
                        </div>
                    </div>
                    <div class="form-group flex items-center mt-4">
                        <input class="form-check-input h-4 w-4 text-indigo-600 border-gray-300 rounded" type="checkbox"
                            id="pagado">
                    ...
                    <div class="flex justify-end mt-6 space-x-3">
                        <button type="button" class="btn btn-product bg-blue-500 text-white py-2 px-4 rounded-md"
                            onclick="openProductModal()">+ Nuevo producto</button>
                        <button type="button" class="bg-gray-500 text-white py-2 px-4 rounded-md">+ Nuevo cliente</button>
                        <button type="button" class="bg-green-500 text-white py-2 px-4 rounded-md"
                            id="addProductsButton">Agregar productos</button>
