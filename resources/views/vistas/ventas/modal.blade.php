<dialog id="productModal" class="modal">
    ...
    <div class="modal-body p-6">
        <input type="text" class="form-control mb-3 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Buscar productos" id="searchProductInput" onkeyup="filterProducts()">
